...
public class MemoryGame
{
  public static void main(String[] args) {
    ...
    RandomPermutation rando = new RandomPermutation();
    String[] memorize = {"a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p",};
    String[] memorize1 = {"a","b","c"};
    board.createBoard(3,true);
    String[] memorize2 = rando.next(memorize1);
    String input = board.playSequence(memorize2, 0.3);
    String correct = memorize2.toString();
